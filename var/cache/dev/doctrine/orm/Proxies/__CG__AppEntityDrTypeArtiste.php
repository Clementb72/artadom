 ...
 */
class DrTypeArtiste extends \App\Entity\DrTypeArtiste implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DrTypeArtiste $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setValeur(string $valeur): \App\Entity\DrTypeArtiste
    {

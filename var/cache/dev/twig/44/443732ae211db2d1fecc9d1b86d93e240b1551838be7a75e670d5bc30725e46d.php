...
class __TwigTemplate_f1268007694faed3890c9b46f3972fdc83a2b19acdfaf53a85505acc84aa2946 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/var/www/app/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
